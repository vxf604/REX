...
def sample_motion_model(rot1, trans, rot2, p: particle):
    ...
    return particle.Particle(updated_x, updated_y, updated_theta)
...
def measurement_model(landmark_pos, p, distance, angle):
    ...
    predicted_angle = math.atan2(landmark_pos[1] - particle_pos[1], landmark_pos[0] - particle_pos[0]) - theta
